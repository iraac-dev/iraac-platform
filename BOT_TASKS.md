...
| SURV-001 | Freeze Have Your Say V1 contract: canonical definition (A–I), stable IDs, Zod validators, branching rules, synthetic fixtures, semantic content hash, immutability guard | hermes (agent_build_test) | PLAT-002, human survey approval (draft baseline) | work/surv-001-survey-contract | packages/survey-contract, BOT_TASKS.md, root scripts/CI | **in progress** | Web/staff/phone adapters consume one contract; active release immutable (hash changes on any mutation); tests green | rhy-collab |
